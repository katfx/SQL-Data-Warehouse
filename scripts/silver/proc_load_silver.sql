...
Parameters:
  Name.
  This stored procedure does not script any parameter or return any values.
	...
	BEGIN TRY
		...
		SELECT prd_id,
			...
			CAST(
				...
				) AS prd_end_dt  -- calculate end date as one day befire the next start date
		...
		SELECT 
			...
			END sls_order_dt, -- handling invalid data, and data casting
		...
		SELECT
			...
			CASE WHEN bdate > GETDATE() THEN NULL
				ELSE bdate
			END cid, -- set future bdates to NULL
